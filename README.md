...
The directory `smoothing_based/` is adapted from this codebase.
...
```
python smoothing_based/train.py cifar10 cifar_resnet110  models/cifar10/resnet110/noise_0.00 --batch 400 --noise 0.00 --gpu [num]

python smoothing_based/train.py imagenet imagenet_vit  models/imagenet/vit/noise_0.00 --batch 400 --noise 0.0
...
```
python lbs_inference/certification_l2.py

python lbs_inference/certification_l1.py

python lbs_inference/certification_l_infinity.py
```
